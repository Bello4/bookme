...
export const updatePassword = (passwords) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.patch('/api/v1/users/updateMyPassword', passwords, config)
        //const data = res.data
...
export const resetPassword = (token, password) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.patch(`/api/v1/users/resetPassword/:${token}`, password, config)
...
export const updateUser = (id, userData) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.patch(`/api/v1/user/${id}`, userData, config)
        //const data = res.data
